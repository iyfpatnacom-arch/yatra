...
const legal = {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "To collect the balance of the yatra donation before departure.",
  ...
  terms: {
    ...
    sections: [
      ...
      {
        heading: "2. Yatra Donation, Booking Amount & Confirmation",
        bullets: [
          "The yatra donation per traveller is shown on the registration form before you pay, and depends on the category and, for families, on the train coach selected.",
          "A booking amount of {advance} per traveller is collected online at the time of registration. This reserves the seat; it is not the full donation.",
  ...
  refund: {
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          "One transfer to a later yatra is permitted where it is requested at least 15 days before departure, and is subject to availability on that yatra. Any difference in the donation amount is payable.",
      ...
      },
      {
        ...
        bullets: [
          ...
          "General donations made to the temple that are not connected to a yatra booking, which are not refundable once processed.",
    ...
    sections: [
      ...
      },
      {
        ...
        bullets: [
          ...
          "The balance of the yatra donation is collected by the coordinator before departure.",
        ],
      },
      {
