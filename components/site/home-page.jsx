...
/**
 * The landing page: photographs on one side, the registration form on the
 * other. Rendered by the home route and by the /youth and /family links, which
 * pass `initialType` so the form opens with that category already chosen.
 */
export function HomePage({ lang, initialType }) {
