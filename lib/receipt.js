 ...
 *
 * Registrations paid through CCAvenue carry it in `payment.raw`, echoed back
 * from CCAvenue's billing page. Razorpay's checkout does not ask for one, so a
 * Razorpay payment prints a dash — every part is optional for that reason,
 * rather than printing "undefined" on a receipt.
 */
